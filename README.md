About pyquil-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyquil-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4132&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyquil-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyquil` can be installed with `conda`:
...
```
mamba install pyquil
```

It is possible to list all of the versions of `pyquil` available on your platform with `conda`:
...
```
mamba search pyquil --channel conda-forge
```
...
mamba repoquery search pyquil --channel conda-forge

# List packages depending on `pyquil`:
mamba repoquery whoneeds pyquil --channel conda-forge

# List dependencies of `pyquil`:
mamba repoquery depends pyquil --channel conda-forge
```
